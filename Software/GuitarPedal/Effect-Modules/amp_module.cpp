...
static const ParameterMetaData s_metaData[s_paramCount] = {{name: "Gain", valueType: ParameterValueType::FloatMagnitude, defaultValue: 64, knobMapping: 0, midiCCMapping: 1},
                                                           ...
                                                           {name: "Model", valueType: ParameterValueType::Binned, valueBinCount: 9, valueBinNames: s_modelBinNames, defaultValue: 0, knobMapping: 4, midiCCMapping: 5},
...
// Default Constructor
AmpModule::AmpModule() : BaseEffectModule(),
                                                        m_gainMin(0.0f),
                                                        m_gainMax(2.0f),
...
float AmpModule::GetBrightnessForLED(int led_id)
{    
