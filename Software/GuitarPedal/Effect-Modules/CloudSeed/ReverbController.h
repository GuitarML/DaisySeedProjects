...
namespace CloudSeed
{
	...
	public:
		...
		void initFactoryChorus()
		{
			...
			//parameters[(int)Parameter2::LineCount] = 1.0;                          // Modified to work with Terrarium switch implementation
		...
		float GetScaledParameter(Parameter2 param)
		{
			...
			{
				// Input
			case Parameter2::InputMix:                  return P(Parameter2::InputMix);
			case Parameter2::PreDelay:                  return (int)(P(Parameter2::PreDelay) * 1000);

			case Parameter2::HighPass:                  return 20 + ValueTables::Get(P(Parameter2::HighPass), ValueTables::Response4Oct) * 980;
			case Parameter2::LowPass:                   return 400 + ValueTables::Get(P(Parameter2::LowPass), ValueTables::Response4Oct) * 19600;

				// Early
			case Parameter2::TapCount:                  return 1 + (int)(P(Parameter2::TapCount) * (MultitapDiffuser::MaxTaps - 1));
			case Parameter2::TapLength:                 return (int)(P(Parameter2::TapLength) * 500);
			case Parameter2::TapGain:                   return ValueTables::Get(P(Parameter2::TapGain), ValueTables::Response2Dec);
			case Parameter2::TapDecay:                  return P(Parameter2::TapDecay);

			case Parameter2::DiffusionEnabled:          return P(Parameter2::DiffusionEnabled) < 0.5 ? 0.0 : 1.0;
			case Parameter2::DiffusionStages:           return 1 + (int)(P(Parameter2::DiffusionStages) * (AllpassDiffuser::MaxStageCount - 0.001));
			case Parameter2::DiffusionDelay:            return (int)(10 + P(Parameter2::DiffusionDelay) * 90);
			case Parameter2::DiffusionFeedback:         return P(Parameter2::DiffusionFeedback);

				// Late
			//case Parameter2::LineCount:                 return 1 + (int)(P(Parameter2::LineCount) * 11.999);
                        case Parameter2::LineCount:                 return (int)(P(Parameter2::LineCount));
			case Parameter2::LineDelay:                 return (int)(20.0 + ValueTables::Get(P(Parameter2::LineDelay), ValueTables::Response2Dec) * 980);
			case Parameter2::LineDecay:                 return 0.05 + ValueTables::Get(P(Parameter2::LineDecay), ValueTables::Response3Dec) * 59.95;

			case Parameter2::LateDiffusionEnabled:      return P(Parameter2::LateDiffusionEnabled) < 0.5 ? 0.0 : 1.0;
			case Parameter2::LateDiffusionStages:       return 1 + (int)(P(Parameter2::LateDiffusionStages) * (AllpassDiffuser::MaxStageCount - 0.001));
			case Parameter2::LateDiffusionDelay:        return (int)(10 + P(Parameter2::LateDiffusionDelay) * 90);
			case Parameter2::LateDiffusionFeedback:     return P(Parameter2::LateDiffusionFeedback);

				// Frequency Response
			case Parameter2::PostLowShelfGain:          return ValueTables::Get(P(Parameter2::PostLowShelfGain), ValueTables::Response2Dec);
			case Parameter2::PostLowShelfFrequency:     return 20 + ValueTables::Get(P(Parameter2::PostLowShelfFrequency), ValueTables::Response4Oct) * 980;
			case Parameter2::PostHighShelfGain:         return ValueTables::Get(P(Parameter2::PostHighShelfGain), ValueTables::Response2Dec);
			case Parameter2::PostHighShelfFrequency:    return 400 + ValueTables::Get(P(Parameter2::PostHighShelfFrequency), ValueTables::Response4Oct) * 19600;
			case Parameter2::PostCutoffFrequency:       return 400 + ValueTables::Get(P(Parameter2::PostCutoffFrequency), ValueTables::Response4Oct) * 19600;

				// Modulation
			case Parameter2::EarlyDiffusionModAmount:   return P(Parameter2::EarlyDiffusionModAmount) * 2.5;
			case Parameter2::EarlyDiffusionModRate:     return ValueTables::Get(P(Parameter2::EarlyDiffusionModRate), ValueTables::Response2Dec) * 5;
			case Parameter2::LineModAmount:             return P(Parameter2::LineModAmount) * 2.5;
			case Parameter2::LineModRate:               return ValueTables::Get(P(Parameter2::LineModRate), ValueTables::Response2Dec) * 5;
			case Parameter2::LateDiffusionModAmount:    return P(Parameter2::LateDiffusionModAmount) * 2.5;
			case Parameter2::LateDiffusionModRate:      return ValueTables::Get(P(Parameter2::LateDiffusionModRate), ValueTables::Response2Dec) * 5;

				// Seeds
			case Parameter2::TapSeed:                   return (int)std::floor(P(Parameter2::TapSeed) * 1000000 + 0.001);
			case Parameter2::DiffusionSeed:             return (int)std::floor(P(Parameter2::DiffusionSeed) * 1000000 + 0.001);
			case Parameter2::DelaySeed:                 return (int)std::floor(P(Parameter2::DelaySeed) * 1000000 + 0.001);
			case Parameter2::PostDiffusionSeed:         return (int)std::floor(P(Parameter2::PostDiffusionSeed) * 1000000 + 0.001);

				// Output
			case Parameter2::CrossSeed:                 return P(Parameter2::CrossSeed);

			case Parameter2::DryOut:                    return ValueTables::Get(P(Parameter2::DryOut), ValueTables::Response2Dec);
			case Parameter2::PredelayOut:               return ValueTables::Get(P(Parameter2::PredelayOut), ValueTables::Response2Dec);
			case Parameter2::EarlyOut:                  return ValueTables::Get(P(Parameter2::EarlyOut), ValueTables::Response2Dec);
			case Parameter2::MainOut:                   return ValueTables::Get(P(Parameter2::MainOut), ValueTables::Response2Dec);

				// Switches
			case Parameter2::HiPassEnabled:             return P(Parameter2::HiPassEnabled) < 0.5 ? 0.0 : 1.0;
			case Parameter2::LowPassEnabled:            return P(Parameter2::LowPassEnabled) < 0.5 ? 0.0 : 1.0;
			case Parameter2::LowShelfEnabled:           return P(Parameter2::LowShelfEnabled) < 0.5 ? 0.0 : 1.0;
			case Parameter2::HighShelfEnabled:          return P(Parameter2::HighShelfEnabled) < 0.5 ? 0.0 : 1.0;
			case Parameter2::CutoffEnabled:             return P(Parameter2::CutoffEnabled) < 0.5 ? 0.0 : 1.0;
			case Parameter2::LateStageTap:			   return P(Parameter2::LateStageTap) < 0.5 ? 0.0 : 1.0;

				// Effects
			case Parameter2::Interpolation:			   return P(Parameter2::Interpolation) < 0.5 ? 0.0 : 1.0;
